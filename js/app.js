...
;(function() {
  ...
  TRANSLATIONS = {
    ...
    en : {CHAPTER_NAME : 'NodeSchool Havana',
          ...
          FOR_EVERYONE_TEXT : 'We think coding is awesome and everyone should feel welcome at our event. This includes that we are expecting all participants to be awesome to each other and respect the <a href="https://github.com/nodeschool/havana/blob/master/Code_of_Conduct.en.md">Code of Conduct</a>.',
